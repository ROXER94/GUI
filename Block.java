...
public class Block {
	...
	double halfwidth; /** Halfwidth of block (the block radius is sqrt(2)*h). */

	/** Body-frame position --- needed for contact processing. */
	Point2d position; // Center of the block (in the image coordinate system)

	/** Constructor: an instance at position (i, j), with color c, position
	 * block center (in image coordinate system) center, and halfwidth hf */
	 ...
	 *            A block.
	 * @param u
	 *            Displacement vector for block a.
	 * @param c
	 *            A block.
	 * @param v
	 *            Displacement vector for block b.
	 * @return True iff (block b displaced by vector u) overlaps (block c
	 *         displaced by vector v).
	 */
	 ...
	 * It is scaled using scale and is displaced using d. clicked indicates
	 * whether it has been clicked on, in which case it appears differently.
	 * overlaps indicates whether it overlaps with some other shape.
	 *
	 * @param g  A Graphics2D object.
	 * @param scale Scale factor from image coordinate system to canvas coordinate
	 *            system.
	 * @param d  Displacement vector for the block.
	 * @param clicked  Indicates whether the shape containing the block has been
	 *            clicked on.
	 * @param overlaps  Indicates whether the shape containing the block overlaps
	 *            another shape.
	 */
	 ...
	 * 
	 * @return The color-based mass described above
	 */
